        ...
        <div className="dashboard">
            <div className="dashboard-card">
                ...
                <div className={sidebar ? "dashboard-options active" : "dashboard-options"}>
                    ...
                    <p className={`dashboard-option ${active === "allbooks" ? "clicked" : ""}`} onClick={() => { setActive("allbooks"); setSidebar(false) }}><BookIcon className='dashboard-option-icon' />ALL Books</p>
                ...
                <div className="dashboard-option-content" style={{ marginTop: "60px" }}>
                    ...
                    {/* <div className="dashboard-addbooks-content" style={active !== "addbook" ? { display: 'none' } : {}}>
                        <AddBook setToast={setToast} setToastMessage={setToastMessage} />
                    </div> */}
