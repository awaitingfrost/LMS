...
import AddBook from "./Dashboard/AdminDashboard/Components/AddBook";
...
function Allbooks({ setToastMessage, setToast }) {
  ...
  return (
    <div className="books-page">
      <Modals title={'Add Book'} open={open} setOpen={setOpen} close={() => setOpen(false)}>
        <AddBook setOpen={setOpen} setToastMessage={setToastMessage} setToast={setToast} />
      </Modals>
